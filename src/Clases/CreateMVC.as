package Clases
{
	public class CreateMVC
	{
		...
		public function MVC_Controller_Create(value:String):String
		{
		 ...
		 return cadena+"\n"+"var "+value+":"+value.substr(0,1).toLocaleUpperCase()+ value.substr(1,value.length).toString()+"=new "+value.substr(0,1).toLocaleUpperCase()+ value.substr(1,value.length).toString()+"(params);"+"\n"+value+".Save();"+"\n"+"\n"+"}";
		}
		...
		public function MVC_Controller_Update(value:String):String
		{
			...
			return cadena+"\n"+"var "+value+":"+value.substr(0,1).toLocaleUpperCase()+value.substr(1,value.length)+"=new "+value.substr(0,1).toLocaleUpperCase()+value.substr(1,value.length)+"(params);"+"\n"+value+".Update();"+"\n"+"\n"+"}";;
		}
